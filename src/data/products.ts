...
export const CATEGORIES: Category[] = [
  {
    ...
    description: 'Stackable, vibrant bracelets crafted with faceted ruby quartz, green aventurine, amethyst, and freshwater pearls.'
  },
  {
    id: 'anklets',
    name: 'Anklets',
    ...
    description: 'Delicate waterproof anklets strung with raw citrine chips, sea glass, and musical bells.'
  },
  {
    id: 'necklaces',
    name: 'Necklaces',
    ...
    description: 'Romantic statement chokers with rose quartz, baroque pearls, and artisan hammered clasps.'
  },
  {
    id: 'earrings',
    name: 'Earrings',
    ...
    description: 'Feather-light beaded drops woven with Japanese Delica seed beads and hypoallergenic surgical steel.'
  },
  {
    id: 'rings',
    name: 'Rings',
    ...
    description: 'Comfortable stretch micro-bead stacking rings decorated with miniature pearls and carnelian.'
  },
  {
    id: 'custom',
    name: 'Custom Pieces',
    ...
    itemCount: 6,
    tagline: 'Bespoke gemstones, custom name initials & anniversary stacks',
    description: 'Bespoke pieces handcrafted to your exact wrist dimensions, birthstones, and preferred metal finishes.'
  }
];
...
export const PRODUCTS: Product[] = [
  {
    ...
    description: 'An enchanting handcrafted bracelet crafted with natural faceted ruby quartz crystal beads and delicate 18k gold-plated star charms. Radiates warmth, romance, and celestial elegance.',
    shortDescription: 'Faceted natural ruby quartz with delicate 18k gold-plated star charms.',
    ...
    rating: 4.9,
    reviewsCount: 48,
    tags: ['Handmade', 'Gemstone', 'Star Charm', 'Ruby', 'Romantic'],
    careInstructions: 'Avoid spraying perfume directly onto the crystals or star charms. Wipe with a dry microfiber cloth.',
    inStock: true
  },
  {
    ...
    description: 'Inspired by morning dew in spring gardens. Hand-woven with genuine green aventurine, sage pressed glass beads, and suspended miniature leaf and flower charms.',
    shortDescription: 'Genuine green aventurine with botanical leaf charms and sage glass beads.',
    ...
    rating: 4.8,
    reviewsCount: 36,
    tags: ['Nature Inspired', 'Botanical', 'Aventurine', 'Green', 'Everyday'],
    careInstructions: 'Keep dry. Store in a soft jewelry pouch to preserve the gold luster.',
    inStock: true
  },
  {
    ...
    description: 'Soft lilac glass beads paired with natural amethyst rondelles and a delicate silk tassel drop. Provides a serene, grounding touch to everyday outfits.',
    shortDescription: 'Natural amethyst rondelles with soft lilac beads and silk tassel drop.',
    ...
    rating: 5.0,
    reviewsCount: 29,
    tags: ['Pastel', 'Amethyst', 'Calm', 'Purple', 'Handmade'],
    careInstructions: 'Gently wipe the amethyst beads with a clean cotton swab.',
    inStock: true
  },
  {
    ...
    description: 'Double-row rich garnet stones accented by brass rondelles. A bold statement piece designed to be stacked with gold bangles or worn solo.',
    shortDescription: 'Double-row natural garnet gemstones with antique brass accents.',
    ...
    rating: 4.9,
    reviewsCount: 52,
    tags: ['Statement', 'Double Layer', 'Garnet', 'Red', 'Boho'],
    careInstructions: 'Store flat to prevent kinking of the steel strand.',
    inStock: true
  },
  {
    ...
    description: 'Cultured freshwater baroque pearls carefully placed on a delicate 14k gold-filled chain with an adjustable extender. The epitome of modern grace.',
    shortDescription: 'Cultured freshwater baroque pearls with 14k gold-filled chain.',
    ...
    rating: 4.9,
    reviewsCount: 64,
    tags: ['Freshwater Pearl', 'Classic', 'Bridal', 'White', 'Timeless'],
    careInstructions: 'Pearls love natural skin moisture! Gently wipe with a soft cloth after wearing.',
    inStock: true
  },
  {
    ...
    description: 'Matte black onyx stones with a center carved metallic accent bead. Understated, grounded, and universally styled for all aesthetics.',
    shortDescription: 'Matte black onyx stones with metallic silver spacer beads.',
    ...
    rating: 4.7,
    reviewsCount: 41,
    tags: ['Onyx', 'Minimalist', 'Unisex', 'Black', 'Casual'],
    careInstructions: 'Clean with lukewarm water and a dry cloth.',
    inStock: true
  },
  {
    ...
    description: 'Warm golden citrine chips intertwined with dainty brass sun charms and tiny bells that softly chime with each gentle step.',
    shortDescription: 'Golden citrine chips with brass sun charms and chime bells.',
    ...
    rating: 4.9,
    reviewsCount: 19,
    tags: ['Anklet', 'Summer', 'Sun Charm', 'Citrine', 'Bohemian'],
    careInstructions: 'Water-safe cord. Rinse after saltwater exposure.',
    inStock: true
  },
  {
    ...
    description: 'Natural turquoise beads combined with tiny sea shells and waterproof wax thread for sunny beach days and summer escapes.',
    shortDescription: 'Natural turquoise beads with miniature shells on waterproof cord.',
    ...
    rating: 4.8,
    reviewsCount: 22,
    tags: ['Beach', 'Turquoise', 'Bohemian', 'Anklet'],
  ...
  },
  {
    ...
    description: 'A romantic necklace featuring hand-cut rose quartz nuggets, mother of pearl stars, and an artisan hammered clasp. Perfect for layered styles.',
    shortDescription: 'Hand-cut rose quartz nuggets with mother of pearl stars and gold chain.',
    ...
    rating: 5.0,
    reviewsCount: 31,
    tags: ['Romantic', 'Rose Quartz', 'Statement', 'Choker', 'Necklace'],
  ...
  },
  {
    ...
    description: 'Hand-woven cascading beaded earrings with deep green glass crystals and hypoallergenic surgical steel hooks. Remarkably lightweight for all-day celebrations.',
    shortDescription: 'Hand-woven green glass crystals with hypoallergenic steel ear hooks.',
    ...
    rating: 4.9,
    reviewsCount: 17,
    tags: ['Earrings', 'Floral', 'Handwoven', 'Green', 'Dangle'],
    careInstructions: 'Hypoallergenic and tarnish-resistant.',
    inStock: true
  },
  {
    ...
    description: 'A curated trio of stretch micro-bead rings with miniature freshwater seed pearls, carnelian, and 14k gold-filled beads. Wear together or spread across your fingers.',
    shortDescription: 'Trio of stretch micro-bead rings with seed pearls and carnelian.',
    ...
    rating: 4.9,
    reviewsCount: 28,
    tags: ['Ring Set', 'Stackable', 'Micro Beads', 'Pearl', 'Rings'],
  ...
  },
  {
    ...
    name: 'Bespoke Custom Name & Birthstone Bracelet',
    ...
    description: 'Create your personalized heirloom piece! Customized with your chosen birthstone crystals, gold letter initial charm, and exact wrist size measurements.',
    shortDescription: 'Handcrafted personalized bracelet with your birthstone crystals and letter initial.',
    materials: ['Choice of Gemstones (Ruby, Amethyst, Quartz)', 'Gold Initial Letter Coin', 'Custom Sizing'],
    ...
    rating: 5.0,
    reviewsCount: 84,
    tags: ['Custom', 'Personalized', 'Birthstone', 'Initial Charm', 'Gift'],
...
export const FAQS: FAQItem[] = [
  ...
  {
    id: 'faq-2',
    question: 'Can I request custom stone combinations, names or colors?',
    answer: 'Absolutely! Maryam loves creating bespoke pieces. Click "Custom Bespoke Request" or use our "Ask Maryam" assistant to specify your preferred gemstones, charms, initials, and size.',
    category: 'Orders & Customization'
  },
  {
    id: 'faq-3',
